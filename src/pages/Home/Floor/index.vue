        ...
        <div class="tab-content">
          <div class="tab-pane">
            <div class="floor-1">
              <div class="blockgary">
                <ul class="jd-list">
                  <li v-for="(item, index) in f.keywords" :key="index">{{item}}</li>
                </ul>
                <img :src="f.imgUrl" />
              </div>
              <div class="floorBanner">
                ...
                <!-- <div class="swiper-container" id="floor2Swiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide" v-for="(item, index) in f.carouselList" :key="item.id">
                      <img :src="item.imgUrl" />
                    </div>
                  </div>
                ...
                <Carousel :carouselList = "f.carouselList"/>
