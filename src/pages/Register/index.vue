  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <img ref="code" src="/api/user/passport/code" alt="code" @click="changeUrl">
      </div>
      <div class="content">
        <label>登录密码:</label>
...
<script>
  ...
  export default {
    ...
    methods: {
      //点击注册
      async submit(){
        const {mobile,password,password2,isAgree,code} = this;
        if(!isAgree){
          alert('请同意')
          return
        }
        ...
        try {
          await this.$store.dispatch('reqRegister',{mobile,password,code})
